...
class TicketManagerTest {
    ...
    Ticket ticket1 = new Ticket (1, 1_299, "SVO", "KZN", 205);
    ...
    Ticket ticket6 = new Ticket (6, 1_299, "SVO", "KZN", 95);
    ...
    @Test
    public void timeFewTicketsFound() {
        ...
        Ticket[] expected = {ticket3, ticket6, ticket5, ticket7, ticket1, ticket4};
        Ticket[] actual = manager.findAll("SVO", "KZN", timeAscComparator);

        Assertions.assertArrayEquals(expected, actual);

    }
    @Test
    public void timeOneTicketsFound() {
        ...
        Ticket[] expected = {ticket2};
        Ticket[] actual = manager.findAll("VKO", "KZN", timeAscComparator);

        Assertions.assertArrayEquals(expected, actual);

    }
    @Test
    public void timeNullTicketsFound() {
        ...
        Ticket[] expected = {};
        Ticket[] actual = manager.findAll("KZN", "VKO", timeAscComparator);
